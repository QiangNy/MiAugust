...
public class DswLog {
    ...
    private static String needWriteFile = "faclog.txt"; // 本类输出的日志文件名称

    public static String LOG_PATH_SDCARD_DIR = "/sdcard/mtklog/factorytest";  // 日志文件在sdcard中的路径
    ...
    public static void setMMILogFile() {
        ...
        needWriteFile = logfile.format(nowtime) + "faclog.txt";
    }
